...
img.onload = function() {
  ...
  */
  ...
  //! BRIGHTNESS (MODE)
  var dark = isItDark(imageData, c)[0];
  var arrayModes = ['Locrian','Phrygian','Aeolian','Dorian','Mixolydian','Ionian','Lydian'];
  // Insert the mode caption in the corresponding <div>
  document.getElementById("mode").textContent = arrayModes[dark-1];
  param.m = dark;

  
  // Mode caption styling
document.getElementById("mode").style.textShadow = "rgba(" + avg[0].toString() + ", " + avg[1].toString() + ", " + avg[2].toString() + ") 1px 0 30px";
